...
public record TextureInfo : Property {
    ...
    ///     reference to a key in `mesh.primitives.attributes` (e.g. a value of `0` corresponds to `TEXCOORD_0`). A mesh
    ///     primitive <b>MUST</b> have the corresponding texture coordinate attributes for the material to be applicable to it.
    /// </summary>
