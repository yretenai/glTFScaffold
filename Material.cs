...
public record Material : ChildOfRootProperty {
    ...
    ///     right and +Y is up. +Z points toward the viewer. If a fourth component (A) is present, it <b>MUST</b> be ignored.
    ...
    ///     areas that receive full indirect lighting and lower values indicate no indirect lighting. If other channels are
    ///     present (GBA), they <b>MUST</b> be ignored for occlusion calculations. When undefined, the material does not have
    ...
    ///     <b>MUST</b> be ignored. When undefined, the texture <b>MUST</b> be sampled as having `1.0` in RGB components.
    /// </summary>
    ...
    ///     `1.0` will render the entire material as fully transparent. This value <b>MUST</b> be ignored for other alpha
    ///     modes. When `alphaMode` is not defined, this value <b>MUST NOT</b> be defined.
    /// </summary>
    [JsonPropertyName("alphaCutoff")]
    public double? AlphaCutoff { get; set; }

    /// <summary>
    ///     Specifies whether the material is double sided. When this value is false, back-face culling is enabled. When
    ///     this value is true, back-face culling is disabled and double-sided lighting is enabled. The back-face <b>MUST</b>
    ///     have its normals reversed before the lighting equation is evaluated.
    /// </summary>
