...
public record BufferView : ChildOfRootProperty {
    ...
    ///     more accessors use the same buffer view, this field <b>MUST</b> be defined.
    /// </summary>
    [JsonPropertyName("byteStride")]
    public int? ByteStride { get; set; }

    /// <summary>The hint representing the intended GPU buffer type to use with this buffer view.</summary>
