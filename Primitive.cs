...
public record Primitive : Property {
    ...
    ///     non-indexed geometry. When defined, the accessor <b>MUST</b> have `SCALAR` type and an unsigned integer component
    ///     type.
    /// </summary>
    ...
    /// <summary>The topology type of primitives to render.</summary>
