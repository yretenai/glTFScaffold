...
public record OrthographicCamera : Property {
    ...
    /// <summary>
    ///     The floating-point vertical magnification of the view. This value <b>MUST NOT</b> be equal to zero. This value
    ///     <b>SHOULD NOT</b> be negative.
    /// </summary>
    [JsonPropertyName("ymag")]
    public double YMagnification { get; set; }

    /// <summary>
    ///     The floating-point distance to the far clipping plane. This value <b>MUST NOT</b> be equal to zero. `zfar`
    ///     <b>MUST</b> be greater than `znear`.
    /// </summary>
